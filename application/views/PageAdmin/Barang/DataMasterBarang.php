                            ...
                            <!-- <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" id="naikHeader" name="naikHeader" placeholder="Persentase Kenaikan Harga" value="">
                                <!-- </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="turunHeader">&nbsp;</label> -->
                                        <input type="hidden" class="form-control" id="turunHeader" name="turunHeader" placeholder="Persentase Turun Harga" value="">
                                    <!-- </div>
                                </div>
                            </div> -->
                ...
                success: function(data) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        row += `<tr>
                                    ...
                                    <td>`;
                                    if (disableBtn != 'hide') {
                                        row += `<button type="button" class="btn btn-xs btn-primary" onClick="editDataBarang('` + kode + `','` + subKode + `','` + data[i].nama_barang + `','` + idBrg + `','` + statusBrg + `','` + data[i].persen_naik + `','` + data[i].persen_turun + `','` + data[i].harga + `')"><i class="fas fa-edit"></i> Edit</button>
